...
const ContactPage = () => {
  ...
  return (
    <main className="flex flex-col md:flex-row gap-8 py-12 px-4 mx-auto max-w-6xl">
      <form
        className="w-full md:w-1/2 bg-white border border-gray-200 rounded-lg shadow-lg p-8 transition-all duration-300 dark:bg-transparent hover:shadow-xl"
        onSubmit={handleSubmit}
      >
        <h2 className=" flex flex-row gap-1 text-2xl font-bold text-gray-800 mb-6 text-center dark:text-white">
      ...
      <div className="w-full md:w-1/2 bg-gray-50 border border-gray-200 rounded-lg p-8 flex flex-col justify-center space-y-6 dark:bg-transparent">
        <div>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            <svg
              ...
              className="h-6 w-6 text-blue-600 dark:text-gray-200"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <span className="text-lg font-medium text-gray-700 dark:text-gray-300">+212 0619965635</span>
          </div>
          <div className="flex items-center space-x-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
